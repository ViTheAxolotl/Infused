...
function updateToken(token)
{
    try 
    {
        ...
        let token = {border : borderColor, currentHp : currentHp.value, maxHp : document.getElementById("max").innerHTML.slice(2), tempHp : tempHp.value, isSummon : wholeDB[char.id]["isSummon"], id : char.id, name : n, title : t, xPos : x, yPos : y, map : "", AC: wholeChar[player]["stats"]["AC"]};
