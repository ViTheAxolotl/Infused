...
let items = 
{
    ...
    "ItAs1Pt" : "A short sword with runes carved into the steel, holding it you feel stronger. It is said that it was forged with the breath of Angiorian, Dragon of Strength. (When attacking with this blade add an additional 2 to your attack roll and damage (Search for Sword of Angiorian under actions and Misc on the dashboard to find it for use))."
...
let img =
{
    ...
    "ItAs1Pt" : "images/items/ItAs1Pt.jpg"
}; //Gets all the images
