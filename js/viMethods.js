...
export function setMapValue()
{
    ...
    {
        bumper = Math.round(trueMapSize / 26) * 0.12;
        movement = distance * 1.2903199999999999999999999;
    }

    else if(screen.width < 1200)
    {
        bumper = Math.round(trueMapSize / 26) * 0.043;
        movement = distance * 1.1900283499999999999999999;
        bubble = -54;
    }
