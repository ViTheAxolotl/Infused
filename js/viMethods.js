...
let webhook; setTimeout(function (){webhook = window.top.parent.wholeChar["Vi"]["webhook"]}, 11 * 1000); //Which channel it goes to by webhook
...
{
    let current = parseInt(window.top.parent.wholeDisplay["current"]);
