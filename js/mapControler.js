...
{
    let bubbleDB = {id : `${player}-bubble`, x : e.offsetX - map.bubble * (zoomLevel/100), y : e.offsetY - map.bubble * (zoomLevel/100), size : 1, src : imgs["borders"][wholeDb[wholeChar[player]["currentToken"]].border]};
