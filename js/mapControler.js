...
{
    let bubbleDB = {id : `${player}-bubble`, x : e.offsetX - map.bubble * zoomLevel, y : e.offsetY - map.bubble * zoomLevel, size : 1, src : imgs["borders"][wholeDb[wholeChar[player]["currentToken"]].border]};
